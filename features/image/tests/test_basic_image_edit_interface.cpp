...
#include "features/image/core/basic_image_edit_interface.h"
...
void TestBasicImageEditInterface::test_load()
{
    ...
    const auto &returnsTrue = [](const QString &) {
        return true;
    };
    const auto &returnsFalse = [](const QString &) {
        return false;
    };
...
void TestBasicImageEditInterface::test_reset()
{
    ...
    const auto &returnsTrue = []() {
        return true;
    };
    const auto &returnsFalse = []() {
        return false;
    };
