...
public:
     ...
     * @return 結果
     */
    EmitResult emitQString(const QVariant &data, DataConversionInterface::Format style,
...
private:
     ...
     */
    YAML::Node variantToYamlNode(const QVariant &value, DataConversionInterface::Format style,
