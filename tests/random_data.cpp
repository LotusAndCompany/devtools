...
const QString RandomData::defaultCharsets =
    numbers + lowerAlphabets + upperAlphabets + " " + symbols;
const QString RandomData::ascii = numbers + lowerAlphabets + upperAlphabets + whitespaces + symbols;

RandomData::RandomData() : RandomData(QDateTime::currentMSecsSinceEpoch()) {}

RandomData::RandomData(int seed) : gen(seed) {}
