...
void TestTomlParser::test_tomlValueToQVariant()
{
...

    {
        ...
        result = TomlParser::tomlValueToQvariant(TomlParser::toml_value_type::local_time_type(
            randomQTime.hour(), randomQTime.minute(), randomQTime.second(), randomQTime.msec()));
        QVERIFY(result);
...

    {
        ...
        result = TomlParser::tomlValueToQvariant(TomlParser::toml_value_type::local_date_type(
            randomQDate.year(), static_cast<toml::month_t>(randomQDate.month() - 1),
            randomQDate.day()));
        QVERIFY(result);
...

    {
        ...
        result = TomlParser::tomlValueToQvariant(TomlParser::toml_value_type::local_datetime_type(
            TomlParser::toml_value_type::local_date_type(
                randomQDate.year(), static_cast<toml::month_t>(randomQDate.month() - 1),
                randomQDate.day()),
            TomlParser::toml_value_type::local_time_type(randomQTime.hour(), randomQTime.minute(),
                                                         randomQTime.second(),
                                                         randomQTime.msec())));
...

    {
        ...
        result = TomlParser::tomlValueToQvariant(TomlParser::toml_value_type::offset_datetime_type(
            TomlParser::toml_value_type::local_date_type(
                ...
                randomQDate.day()),
            TomlParser::toml_value_type::local_time_type(randomQTime.hour(), randomQTime.minute(),
                                                         randomQTime.second(), randomQTime.msec()),
        ...
        result = TomlParser::tomlValueToQvariant(TomlParser::toml_value_type::offset_datetime_type(
            TomlParser::toml_value_type::local_date_type(1970, static_cast<toml::month_t>(0), 1),
            TomlParser::toml_value_type::local_time_type(0, 0, 0, 0), toml::time_offset(12, 59)));
        QVERIFY(result);
        QCOMPARE_EQ(result.data.toDateTime(),
