 ...
 *          テンプレートパラメータは std::function<> と同じように result_type(arg_types...) という形で渡す。
 * 
 * @code
 * // declarations
 ...
 * FunctionMock<void()> mock_process(printHello); // function pointer is also available. you should define `void printHello()` somewhere.
 * 
 * // mock implementation
